...
long int brakelimit=500;//实际低速时脉冲数，需测试
uint8 highduty=10;//最高占空比
uint8 lowduty=3;//最低占空比
float A=0.0005;//电机控制参数，duty=(-A)*error*error+highspeed
...
void Motor_init(void)
{
	...
	FTM_PWM_init(FTM0, FTM_CH3, Motor_Hz,100);//野火使用CH3，CH4
