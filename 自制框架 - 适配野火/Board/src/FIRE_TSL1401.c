...
#if 1             //宏条件编译选择不同的信号类型
ADCn_Ch_e   tsl1401_ch[] = {ADC0_DP1,     ADC0_DP0};       //CCD所用的 ADC通道(原始信号)
#else
ADCn_Ch_e   tsl1401_ch[] = {ADC0_DM1,     ADC0_DM0};       //CCD所用的 ADC通道(放大信号)
#endif
PTXn_e      tsl1401_si[] = {PTE6 ,        PTE8};          //CCD所用的 SI管脚
PTXn_e      tsl1401_clk[] = {PTE7 ,        PTE9};         //CCD所用的 SI管脚
PTXn_e      tsl1401_led[] = {PTA8 ,        PTA9};         //CCD 补光 所用的 LED_EN 管脚
